...
#ifdef _Ink2011M_LINUX_DRIVER_    // Added by SteadyBJ, Wang Shouye, 2010-08-12
#ifndef _Ink2011_LINUX_DRIVER_    // Removed by SteadyBJ, Zou Shujun, 2012-02-02
#define MFC_J6310W	"mfcj6310w"
#define MFC_J6510DW	"mfcj6510dw"
#endif  // end  _Ink2011_LINUX_DRIVER_
...
#ifdef _Ink2011_LINUX_DRIVER_ // Added by SteadyBJ, Li Yong, 2011-12-21
int exec_brprintconf(char *brprintconf,char *printer,char* rcfilepath);
#else   //  _Ink2011_LINUX_DRIVER_
...
#if 0	/*Ink2009. Chenyipan. 20080715*/
  //************************************
...
int add_command_list_brcommand_sub(char  *command){
  ...
  option[strlen(option)] = 0;	/*Ink2009. Chenyipan. 20080715*/
