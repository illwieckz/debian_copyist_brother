...
#ifndef _MODEL2011_LINUX_DRIVER_      // Removed by SteadyBJ, developer7, 2012.01.31
#define MFC_J6310W	"mfcj6310w"
#define MFC_J6510DW	"mfcj6510dw"
#endif  // end  _MODEL2011_LINUX_DRIVER_
...
#ifdef _MODEL2011_LINUX_DRIVER_ // Added by SteadyBJ, developer4, 2011-12-21
int exec_brprintconf(char *brprintconf,char *printer,char* rcfilepath);
#else   //  _MODEL2011_LINUX_DRIVER_
...
#if 0	/*MODEL2009. developer5. 20080715*/
  //************************************
...
int add_command_list_brcommand_sub(char  *command){
  ...
  option[strlen(option)] = 0;	/*MODEL2009. developer5. 20080715*/
