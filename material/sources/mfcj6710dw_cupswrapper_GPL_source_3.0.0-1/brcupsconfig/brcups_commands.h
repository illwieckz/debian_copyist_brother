...
#ifndef _MODEL2009_    /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
#define _MODEL2009_
#endif   /*_MODEL2009_*/

#ifndef _MODEL2011C_LINUX_DRIVER_		/*MODEL2011C, Add by SteadyBJ, developer3, 2010-08-12*/
#define _MODEL2011C_LINUX_DRIVER_
#endif		// end _MODEL2011C_LINUX_DRIVER_

#ifndef _MODEL2011_LINUX_DRIVER_ // Added by SteadyBJ, developer4, 2011-12-18 MODEL2011.
#define _MODEL2011_LINUX_DRIVER_
#endif //end _MODEL2011_LINUX_DRIVER
...
#ifndef _MODEL2011C_LINUX_DRIVER_ // Removed by SteadyBJ, developer3, 2010-08-12
	// Collate
	{  "Collate=OFF"			,	"-collate OFF"      },
	{  "Collate=ON"				,	"-collate ON"      },
#endif  // end _MODEL2011C_LINUX_DRIVER_

#ifdef _MODEL2011C_LINUX_DRIVER_ // Modified by SteadyBJ, developer3, 2010-08-12
...
#else    // _MODEL2011C_LINUX_DRIVER_
  // Media  
#ifdef _MODEL2009_    /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
...
#else    // _MODEL2011C_LINUX_DRIVER_	
	// Mirror
#ifdef _MODEL2009_    /*MODEL2009. Modified by developer5. 20080519*/
	{  "MirrorPrint=OFF"	,	"-mirro False"	},
	{  "MirrorPrint=ON"	,	"-mirro True"	},
	{  "noBRMirror"	,	"-mirro False"	},	// For Debian
	{  "BRMirror"	,	"-mirro True"	},		// For Debian
#else        /*MODEL2009. Modified by developer5. 20080519*/
	{  "MirrorPrint=OFF"	,	"-mirro OFF"	},
	{  "MirrorPrint=ON"	,	"-mirro ON"	},
	{  "NoMirrorPrint"	,	"-mirro OFF"	},
	{  "MirrorPrint"	,	"-mirro ON"	},
#endif      /*MODEL2009. Modified by developer5. 20080519*/

#endif   // end  _MODEL2011C_LINUX_DRIVER_


#ifdef _MODEL2009_    /*MODEL2009. Modified by developer5. 20080701*/
...
//	{  "media=EnvYou4"				,	"-pt EnvYou4"			},
  ...
  { "PageSize=BrA3_B_S",				"-pt BrA3_B_S" },
  { "PageSize=BrA3_B_A3",				"-pt BrA3_B_A3" }, /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
  { "PageSize=B4",				"-pt B4" },
  { "PageSize=BrB4_S",				"-pt BrB4_S" },/*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
  ...
  { "PageSize=BrA4_B",			"-pt BrA4_B" },
	...
	// for Command Line
#ifdef _MODEL2009_    /*_MODEL2009_*/    /*Modified by developer2.SteadyBJ.2008.4.28*/
  { "media=A3",				"-pt BrA3_S" },
  { "media=BrA3_A3",				"-pt BrA3_A3" },
  { "media=BrA3_B_S",				"-pt BrA3_B_S" },
  { "media=BrA3_B_A3",				"-pt BrA3_B_A3" }, /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
  { "media=B4",				"-pt B4" },
  { "media=BrB4_S",				"-pt BrB4_S" },/*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
...
#ifdef _MODEL2011C_LINUX_DRIVER_ // Added by SteadyBJ, developer3, 2010-08-12
...
#endif /*_MODEL2009_*/     /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/

	{ NULL   ,   NULL    },

};

#ifdef _MODEL2011C_LINUX_DRIVER_ // Added by SteadyBJ, developer3, 2010-12-15
...
#ifdef _MODEL2011C_LINUX_DRIVER_ // Removed by SteadyBJ, developer3, 2010-08-12
	{	"Copies="   	,   "-copy "      },
#endif // end  _MODEL2011C_LINUX_DRIVER_
	{	"BRBrightness="	,	"-brit "	},
	{	"BRContrast="		,	"-cont "		},
...
PPDCOMMAND  DefaultPageSize={
  ...
  { "BrA3_A3",				"-pt BrA3_A3" },
  { "BrA3_B_S",				"-pt BrA3_B_S" },
  { "BrA3_B_A3",				"-pt BrA3_B_A3" }, /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
  { "B4",				"-pt B4" },
  { "BrB4_S",				"-pt BrB4_S" },/*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
...
PPDCOMMAND  DefaultBRMirrorPrint={
	"DefaultBRMirror",
	{
#ifndef _MODEL2009_	/*MODEL2009. Modified by developer5. 20080519*/
		{  "OFF"	,	"-mirro OFF"	},
...
#endif     /*MODEL2009,Add by developer2,SteadyBJ,2008.4.17*/
...
PPDCOMMAND   *ppdcommand_all_list[] = {
  ...
  &DefaultBRJpeg,
  &DefaultBRReverse,
#ifdef _MODEL2011C_LINUX_DRIVER_ // Add by SteadyBJ, developer3, 2010-08-12
  &DefaultBRDuplex,
  &DefaultDuplexMode,
  &DefaultBRManualDuplex,
#endif   // end _MODEL2011C_LINUX_DRIVER_
