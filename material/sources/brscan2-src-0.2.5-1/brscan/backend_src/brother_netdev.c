...
///////////////////////////////////////////////////////////////////////////////
//
//	Source filename: brother_netdev.c
//
//		Copyright(c) 2006-2008 Brother Industries, Ltd.  
//               All Rights Reserved.
//
//
//	Abstract:
...
br_net_dev_handle  open_device_net(int dev_index,
  ...
  h_dev = calloc(1,sizeof(br_net_dev_handle_body));
  // M-LNX-88 br_net_dev_handle  -> br_net_dev_handle_body
